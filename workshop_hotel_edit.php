...
/*******************************Beginning of the conditional page you can choose to see hotels from a certain city or the whole certain state***************************************/
...
echo "<tr><td style=\"padding:10px;\"><a href=\"http://www.seriouslyfunnyscience.com/workshops/workshop_hotel_edit.php?hotels_id=" . "$hotel_q_row[hotels_id]&submit=Go" . "\">Edit</a></td><td style=\"padding:10px;\"><h4>" . "$hotel_q_row[hotels_name]</h4><br />$hotel_q_row[hotels_address]<br />$hotel_q_row[hotels_city] $hotel_q_row[hotels_state], $hotel_q_row[hotels_zip]</td>";

echo "<td style=\"padding:10px;\"><p style=\"font-size: 12px;\">Room Size: $hotel_q_row[hotels_meet_room_sq_ft] <br />Room Price: $hotel_q_row[hotels_meet_room_price]<br />Max Room Size: $hotel_q_row[hotels_meet_room_max_sq_ft]</p><p style=\"font-size: 12px;\">Sleep Room Price: $hotel_q_row[hotels_sleep_room_price]</p><p style=\"font-size: 12px;\">Danish /doz: $hotel_q_row[hotels_danish] <br />Coffee /Gal: $hotel_q_row[hotels_coffee]</p><p style=\"font-size: 12px;\">Parking Fee: <strong>$hotel_q_row[hotels_parking]</strong> <br />A/V Fee: $hotel_q_row[hotels_lav]</p></td>";

echo "<td style=\"padding:10px;\"><p>Contact: $hotel_q_row[hotels_contact]<br />e-Mail: <a href=\"mailto:$hotel_q_row[hotels_email]\">$hotel_q_row[hotels_email]</a></p><p>Main #: $hotel_q_row[hotels_main_phone]<br />Catering #: $hotel_q_row[hotels_cat_phone] <br />Fax #: $hotel_q_row[hotels_fax]</p><p>Directions Link: ";
...
echo "</p></td>";
echo"<td style=\"padding:10px;\"><p style=\"font-size: 12px;\">Rating: $hotel_q_row[hotels_rating] <br /><em>Notes:</em> <br />$hotel_q_row[hotels_notes]</p><br /><p style=\"font-size: 12px;\"><em>Shipping Notes:</em> <br />$hotel_q_row[hotels_shipping_info]</p>" . "</td></tr>\n";
/*print date('M d, Y', strtotime($row['wdate']));*/
echo "";
}
echo "</table><br />";
...
/********************End of the first conditional page to see hotels per city or state*******************/
...
?>
<form id="hotels" name="hotel" method="post" action="<?php echo $thispage; ?>?update=1&submit=submit&hotels_id=<?php echo "$h_id"; ?>">
...
<br />
<br />
<label><input name="hotels_city_post" type="text" size="20" maxlength="20" value="<?php echo "$hotel_q_edit_row[hotels_city]"; ?>" /> City</label>&nbsp;&nbsp;&nbsp; 
<label><select tabindex="4" name="hotels_state_post">
...
/*****************************Insert new values into the hotel database*************************************/
