...
<body><main style="margin-left:20px; margin-right:20px;"><a href="mailto:
<?php
//echo '';
...
?>
?subject=IMPORTANT: Loose in the Lab workshop related information.">E-Mail Link. Click this link to mail to everyone who IS YET TO attend our workshop.</a><p>Total of <strong>
<?php
echo " $numofrows ";
?>
